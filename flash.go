...
var flashMessages = map[string]string{
	...
	"loan_copy_not_on_loan":              "That copy is not currently checked out.",
	"loan_undo_invalid":                  "Could not undo: invalid loan reference.",
	"loan_undo_not_found":                "Could not undo: loan no longer exists.",
	"loan_undo_already_returned":         "Could not undo: that loan has already been returned.",
	"internal_error":                     "Something went wrong. Please try again.",
	"copy_added_bulk":                    "Copies added:",
	"copy_count_invalid":                 "Copy count must be a positive integer.",
